...
export default function Registration() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Redirect to success page after showing success message briefly
    setTimeout(() => {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 rounded-lg bg-white/5 border ${errors.phone ? "border-red-500" : "border-white/10"
                      } text-white placeholder-white/30 focus:border-[#00f0ff] focus:outline-none focus:ring-1 focus:ring-[#00f0ff] transition-colors`}
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 rounded-lg bg-white/5 border ${errors.college ? "border-red-500" : "border-white/10"
                      } text-white placeholder-white/30 focus:border-[#00f0ff] focus:outline-none focus:ring-1 focus:ring-[#00f0ff] transition-colors`}
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 rounded-lg bg-white/5 border ${errors.competition ? "border-red-500" : "border-white/10"
              ...
              <div className="pt-4">
                <button
                  ...
                  className={`w-full py-4 rounded-full font-bold text-lg tracking-wider flex items-center justify-center gap-3 transition-all duration-300 ${submitStatus === "success"
